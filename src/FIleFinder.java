...
A File Finder project based on java 
...
if (Flag==1)
System.out.println("File "+FileName+" not found or maybe is hidden or at the worst it does not exist.");
}
}
